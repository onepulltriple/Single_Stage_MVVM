...
INSERT INTO Show 
    ...
    ('8',  'RUFF', '2026-08-12 14:00:00', '2026-08-12 20:00:00', '55.00', '1'),
    ('9',  'CMON', '2026-08-14 19:00:00', '2026-08-14 23:00:00', '75.00', '0'),
    ('10', 'A#$A', '2026-08-15 08:00:00', '2026-08-15 10:00:00', '40.00', '1'),
...
DELETE FROM ArtistPerformance
SET IDENTITY_INSERT ArtistPerformance ON;
INSERT INTO ArtistPerformance 
	(id, RoyaltyUpFront, RoyaltyAtEnd, Artist_id, Performance_id) 
	VALUES 
	('1','3000','9000',1,1)
SET IDENTITY_INSERT ArtistPerformance OFF;

SELECT * FROM ArtistPerformance ORDER BY id
